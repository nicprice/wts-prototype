...
if ($('#ewc-wastes-typeahead-container').length > 0) {
  element = document.querySelector('#ewc-wastes-typeahead-container')
  id = 'ewc-wastes-typeahead' // To match it to the existing <label>.

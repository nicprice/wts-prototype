...
if ($('#sic-codes-typeahead-container').length > 0) {
  element = document.querySelector('#sic-codes-typeahead-container')
  id = 'sic-codes-typeahead' // To match it to the existing <label>.
